...
(async function(){
 ...
 if(!sb?.auth){root.innerHTML='<div class="status">Web3Market connection could not be initialized. Please refresh the page.</div>';return;}
 try{
 ...
 }catch(e){console.error('Web3Market verification:',e);root.innerHTML='<div class="status">Unable to load verification. Please refresh and try again.</div>';}
})();
