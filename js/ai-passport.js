...
function renderExternal(p){
 ...
 h+='</div></section><section class="passport-card"><h2>Passport Status</h2><div class="identity"><div class="item"><small>Passport ID</small><strong>'+esc(val(p.passport_id))+'</strong>'+status('connected','Stored')+'</div><div class="item"><small>Snapshot</small><strong>'+esc(val(p.snapshot_id))+'</strong>'+status('connected','Current')+'</div><div class="item"><small>Monitoring</small><strong>Available</strong>'+status('connected','Engine Ready')+'</div></div></section><section class="passport-card"><h2>Research Summary</h2><p>'+esc(val(p.ai_summary))+'</p></section><section class="passport-card"><h2>Key Findings</h2>';
 ...
 h+='</section><section class="passport-card"><p class="muted"><strong>Important:</strong> This Passport is external public research. It is not a Web3Market listing, is not owner-verified, and does not create or modify marketplace project data.</p></section>';
 document.getElementById('passport').innerHTML=h;
}
