...
(async function(){
  ...
  const walletModal=document.getElementById("walletModal"); if(walletModal){walletModal.hidden=true;walletModal.style.setProperty("display","none","important");}
    ...
    const walletScript=document.createElement("script"); walletScript.src="js/seller-wallet.js?v=20260918-dashboard-wallet7"; document.body.appendChild(walletScript);
})();