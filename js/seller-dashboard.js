...
(async function(){
  ...
  try{
    ...
    const walletScript=document.createElement("script"); walletScript.src="js/seller-wallet.js?v=20260918-dashboard-wallet2"; document.body.appendChild(walletScript);
})();