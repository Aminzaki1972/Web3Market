...
(async function(){
 ...
 <p>Seller net: <strong>${net.toLocaleString()} ${currency}</strong></p>
 <p class="status">The platform fee is locked for this deal. Web3Market does not custody funds on this page.</p>
 <p>This workspace tracks the acquisition lifecycle. Funding, custody and asset transfer require a separately audited escrow or payment integration.</p>
