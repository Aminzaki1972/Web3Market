...
(function(){
  ...
  function ensureModal(){
    ...
    m.innerHTML='<div style="width:min(430px,100%);max-height:85vh;overflow:auto;background:#15132a;border:1px solid #443270;border-radius:18px;padding:18px;color:#fff"><div style="display:flex;justify-content:space-between;align-items:center"><div><strong style="font-size:17px">Connect Web3 Wallet</strong><div style="font-size:10px;color:#aaa3c3;margin-top:4px">Choose your wallet to connect and verify ownership</div></div><button id="buyerWalletClose" type="button" aria-label="Close wallet list" title="Close" onclick="this.closest(\'#buyerWalletModal\').hidden=true;" style="pointer-events:auto;position:relative;z-index:100000;width:36px;height:36px;border:1px solid #4a3b68;border-radius:10px;background:#211b35;color:#fff;font-size:25px;line-height:1;cursor:pointer;display:grid;place-items:center;touch-action:manipulation">×</button></div><div id="buyerWalletList"></div><div id="buyerWalletNotice" style="font-size:10px;color:#a9a2bd;margin-top:10px;line-height:1.5"></div></div>';
