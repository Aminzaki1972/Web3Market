...
(function(){
  ...
  function loadManager(){
    ...
    return new Promise(resolve=>{
      ...
      if(!s){s=document.createElement("script");s.id=id;s.src="js/wallet-manager.js?v=20260921-walletfix16";s.async=false;s.onload=resolve;s.onerror=resolve;document.head.appendChild(s)}else s.addEventListener("load",resolve,{once:true});
