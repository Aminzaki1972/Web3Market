...
(function(){
  ...
  function ensureModal(){
    ...
    if(closeBtn){
      ["click","pointerup","touchend","mousedown"].forEach(type=>closeBtn.addEventListener(type,e=>{e.preventDefault();e.stopImmediatePropagation();closeModal(m)}, {capture:true,passive:false}));
    }
    return m;
  }
