...
(async function(){
 ...
 try{
  ...
  const {data:intel}=await sb.from("project_intelligence").select("project_id,overall_score,confidence_score,risk_level,valuation_mid,valuation_low,valuation_high,price_position").in("project_id",ids);
