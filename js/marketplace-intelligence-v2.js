...
(async function(){
 ...
 try{
  await wait();
  /* Intelligence is enhancement only: never remove a valid marketplace listing. */
  ...
  if(error){console.warn("Web3Market intelligence query unavailable",error);return;}
