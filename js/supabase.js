...
function loadRealMarketplace(){if(!document.querySelector('.listingGrid')||document.getElementById('web3market-real-marketplace'))return;const s=document.createElement('script');s.id='web3market-real-marketplace';s.src='js/real-marketplace.js?v=20260911-3';s.async=true;s.onerror=function(){console.warn('Web3Market real marketplace unavailable')};document.body.appendChild(s)}
